    ...
    >
      <div className="max-w-screen-lg p-10 mx-auto flex flex-col gap-5 justify-center w-full h-full">
        <div className="pb-8 flex justify-center mob_about">
          <p className="text-4xl font-bold inline border-b-4 border-gray-500" style={{ fontFamily: 'Playpen' }}>
            About Me
          </p>
        </div>
        <p className="mb-3 text-white-500 dark:text-white-400 hidden sm:block" style={{ fontFamily: 'Playpen Sans' }}>
        ...
        <p className="text-white-500 dark:text-white-400 hidden sm:block" style={{ fontFamily: 'Playpen Sans' }}>
        ...
        <p className="text-white-500 dark:text-white-400 mob_about_p" style={{ fontFamily: 'Playpen Sans' }}>
