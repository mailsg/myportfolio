  ...
  return (
    ...
    <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-around h-full px-4 md:flex-row">
        <div className="flex flex-col justify-center mr-40 h-full home">
          <h2 className="text-5xl mt-12 sm:mt-0 sm:text-7xl font-bold text-white anime"  style={{ fontFamily: 'Playpen' }}>
            Hey There,<br /> I am Sandeep.
          </h2>
          <p className="text-white py-4 max-w-md" style={{ fontFamily: 'Playpen Sans' }}>
            <br />
            I am a Full Stack Developer with expertise in building products, features and web apps. 
            Explore my portfolio and experience. 
            If my work aligns with your requirements, feel free to reach out for your products or projects.
          </p>
          <div>
          <br />
          <a
